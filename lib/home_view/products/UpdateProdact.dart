...
class UpdateProdactScreen extends StatelessWidget {
  Prodact prodact;
  String catId;
  UpdateProdactScreen(this.catId, this.prodact);
  @override
    ...
    return Consumer<FirestorProveder>(builder: (context, provider, x) {
      return SafeArea(
          child: Scaffold(
              ...
              appBar: AppBar(
                title: const Text("Updata  Prodact"),
                      ...
                      children: [
                        ...
                        provider.selectedImage == null
                            ? InkWell(
                                ...
                                child: CircleAvatar(
                                  radius: 50,
                                  backgroundImage: NetworkImage(prodact.imag),
                                ),
                              )
                            : CircleAvatar(
                                radius: 50,
                        ...
                        DefultBigButton(
                            ontab: (() async {
                              ...
                              await provider.updateProduct(prodact, catId);
